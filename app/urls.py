...
urlpatterns = [
    ...
    path('api/productos/', views.productos_json, name='productos_json'),   #Devuelve los productos en formato JSON. Sirve para usar los datos desde JavaScript u otra app.
